...
public class MouvementStockController {
    ...
    public String listMouvements(Model model) {
        ...
        model.addAttribute(
                "types",
                typeMouvementStockRepository.findAll());
    ...
    public String showForm(
        ...
        if (id != null) {
            ...
            Optional<MouvementStockAliment> mouvementOpt =
                    mouvementStockRepository.findById(id);
            ...
            if (mouvementOpt.isPresent()) {
                ...
                dto.setTypeMouvementStockId(
                        m.getTypeMouvementStock().getId());
    ...
    public String saveMouvement(
            @ModelAttribute MouvementStockDTO dto,
            Model model) {
        ...
        Optional<TypeMouvementStock> typeOpt =
                typeMouvementStockRepository.findById(
        ...
        if (ingredientOpt.isEmpty() || typeOpt.isEmpty()) {
            ...
            model.addAttribute(
                    "message",
                    "Ingredient ou type de mouvement introuvable.");
        ...
        if (dto.getId() != null) {
            ...
            mouvement =
                    mouvementStockRepository
                            .findById(dto.getId())
                            .orElse(new MouvementStockAliment());
        ...
        mouvement.setIngredient(
                ingredientOpt.get());

        mouvement.setTypeMouvementStock(
                typeOpt.get());

        mouvement.setQuantiteKg(
                dto.getQuantiteKg());

        mouvement.setPrixTotal(
                dto.getPrixTotal());

        mouvement.setDateMouvement(
                dto.getDateMouvement() != null
                        ? dto.getDateMouvement()
                        : LocalDateTime.now());
        ...
        return "redirect:/ressources/mouvementsStock";
    }

    @PostMapping("/stocks/mouvements/delete/{id}")
    public String deleteMouvement(
